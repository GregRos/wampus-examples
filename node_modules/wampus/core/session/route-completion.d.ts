 ...
 */
export declare enum WampusCompletionReason {
    /**
 ...
 */
export declare class WampusRouteCompletion extends Error {
    reason: WampusCompletionReason;
    msg?: WampMessage.Any;
    constructor(reason: WampusCompletionReason, msg?: WampMessage.Any);
}
